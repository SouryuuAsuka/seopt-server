...
const proptType = {
  ...
  3: 'Тебе будет предоставлен текст. Твоя задача - перевести этот текст на английский.',
  4: 'Тебе будет предоставлен текст. Твоя задача - перевести этот текст на русский.',
}
